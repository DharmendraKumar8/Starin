...
import com.starin.exceptions.KeyNotFoundException;
...
public class ObjectMap {
	...
	public static String jsonString(List<?> objects){
     	JSONArray jsonArray = new JSONArray(objectMap(objects));
		return jsonArray.toString();
	}
	public static String jsonString(List<?> objects,String key){
     	JSONArray jsonArray = new JSONArray(objectMap(objects,key));
		return jsonArray.toString();
	}
